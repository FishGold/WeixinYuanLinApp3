...
<head lang="en">
    ...
    <link rel="stylesheet" href="../css/myDonateSingle.css">
</head>
<body>
<header>
    <img id="header" src="../images/util/5.jpg">
    <p id="title">捐赠的植物的名字</p>
</header>
<table>
    <tr>
...
<hr>
<button class="btn btn-primary btn-block" onclick="location.href='http://localhost:8080/myDonate/main'">返  回</button>
<script>
